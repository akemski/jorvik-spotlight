const CLUBS = [
  ...
  },
  {
    ...
    members: "17",
    meetingTimes: "Tuesday & Thursday 8:00pm",
    language: "German",
    ...
    avatarColor: "#a0e0a0",
    description: "Hey, we are The Dinosaur Agency — a dressage and leisure club from server three. We meet on Tuesdays and Thursdays in the evenings for dressage or various activities like hide and seek, leveling, or whatever the members feel like doing.",
    requirements: "Age 15+ · Level 10+ · Discord required",
    visit: null,
    spotlight: null
  },
  {
